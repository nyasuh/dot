require '/home/kaze/.config/obmenu-generator/config.pl';
...
{begin_cat => ['Terminal', 'Terminal']},
    ...
    {item => ['termite',           'Termite',      'terminal']},
{end_cat => undef},
{begin_cat => ['Browser', 'Browser']},    
    {item => ['firefox www.archbang.org',           'Firefox',       'web-browser']},
    {item => ['sh /home/kaze/Documents/Tor/tor-browser_en-US32/Browser/start-tor-browser',           'Tor',       'web-browser']},
{end_cat => undef},
    {sep => undef},
    {item => ['/home/kaze/scripts/dmenu.sh',         'Run',       'system-run']},
